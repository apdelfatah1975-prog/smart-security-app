...
export const children = pgTable(
  "children",
  {
    ...
    ownerId: integer("ownerId").notNull().references(() => users.id, { onDelete: "cascade" }),
    fullName: varchar("fullName", { length: 160 }).notNull(),
    relation: varchar("relation", { length: 40 }).default("ابن/ابنة"),
    nationalId: varchar("nationalId", { length: 14 }),
    birthDate: timestamp("birthDate"),
    grade: varchar("grade", { length: 80 }),
    school: varchar("school", { length: 160 }),
    phone: varchar("phone", { length: 32 }),
    bloodType: varchar("bloodType", { length: 12 }),
...
export const lessons = pgTable(
  "lessons",
  {
    ...
    weekDay: varchar("weekDay", { length: 30 }),
